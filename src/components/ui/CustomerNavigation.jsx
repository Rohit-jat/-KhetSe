...
function CustomerNavigation() {
  ...
  const navigationItems = [
    { label: 'All items', path: '/menu-browse-search', icon: 'ChefHat' },
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/menu-browse-search" className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
             <img src="https://res.cloudinary.com/dd4vunvtj/image/upload/v1752659805/farmer_fmrrqf.png" alt="" />
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <Icon name={isMobileMenuOpen ? "X" : "All items"} size={24} />
            </button>
          </div>
        </div>
      </div>
